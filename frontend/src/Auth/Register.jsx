  ...
  return (
    <div className="mt-2" aria-live="polite" aria-atomic="true">
      ...
      <p className="text-xs text-[var(--color-text-muted)]">
        Strength: <span className="font-medium text-[var(--color-text-secondary)]">{labels[score] || 'Too short'}</span>
      </p>
    </div>
  );
};
    ...
    <main className="min-h-screen bg-[var(--color-bg)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-semibold text-[var(--color-text-primary)] tracking-tight">Create an account</h1>
          <p className="mt-1.5 text-sm text-[var(--color-text-muted)]">Get started — it only takes a moment</p>
        </div>
