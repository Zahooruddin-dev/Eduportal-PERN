...
export default function ResourceManager({
	...
	const loadProgressSummaries = useCallback(
		async (resourceItems) => {
			const youtubeResources = (resourceItems || []).filter(
		...
		<div className='p-4 sm:p-6'>
			...
			<section className='mb-4 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4'>
				<div className='grid grid-cols-1 gap-3 md:grid-cols-3'>
					<div>
						<label
							htmlFor='teacher-resource-search'
							className='mb-1 block text-xs uppercase tracking-wide text-[var(--color-text-muted)]'
						>
							Search
						</label>
					...
					<div>
						<label
							htmlFor='teacher-resource-tag-filter'
							className='mb-1 block text-xs uppercase tracking-wide text-[var(--color-text-muted)]'
						>
							Tag
						</label>
			...
			{showAddForm && (
				...
				>
					...
					<form onSubmit={handleSubmit} className='space-y-4'>
						<div>
							<label
								htmlFor='teacher-resource-title'
						...
						<div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
							<div>
								<label
									htmlFor='teacher-resource-content-mode'
									className='mb-1 block text-sm text-[var(--color-text-secondary)]'
								>
									Mode
								</label>
							...
							<div>
								<label
									htmlFor='teacher-resource-category'
									className='mb-1 block text-sm text-[var(--color-text-secondary)]'
								>
									Category
								</label>
						...
						<div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
							<div>
								<label
									htmlFor='teacher-resource-description'
									className='mb-1 block text-sm text-[var(--color-text-secondary)]'
								>
									Description
								</label>
							...
							<div className='space-y-3'>
								...
								<div>
									<label
										htmlFor='teacher-resource-expires'
										className='mb-1 block text-sm text-[var(--color-text-secondary)]'
									>
										Expires At (optional)
									</label>
			...
			{resources.length === 0 ? (
				<div className='rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-8 text-center'>
					<p className='text-[var(--color-text-muted)]'>
						No resources yet for this class.
					</p>
				</div>
								...
								<div className='flex flex-wrap items-start justify-between gap-3'>
											...
											<div className='mt-3 grid grid-cols-2 gap-2 rounded-xl border border-[var(--color-border)] bg-[var(--color-input-bg)] p-2 text-xs sm:grid-cols-4'>
												<div>
													...
													<p className='font-semibold text-[var(--color-text-primary)]'>
														{progressSummary.tracked_students ?? 0}
													</p>
												</div>
												<div>
													<p className='text-[var(--color-text-muted)]'>
													...
													<p className='font-semibold text-[var(--color-success)]'>
														{progressSummary.threshold_students ?? 0}
													</p>
												</div>
												<div>
													<p className='text-[var(--color-text-muted)]'>
													...
													<p className='font-semibold text-[var(--color-text-primary)]'>
														{progressSummary.avg_progress_percent ?? 0}
													</p>
												</div>
												<div>
													<p className='text-[var(--color-text-muted)]'>
													...
													<p className='font-semibold text-[var(--color-text-primary)]'>
														{progressSummary.max_progress_percent ?? 0}
													</p>
												</div>
											</div>
										)}
									...
									<div className='flex items-center gap-1'>
										<button
											...
											aria-label={
												resource.is_published
													? 'Move resource to draft'
													: 'Publish resource'
											}
											title={
												resource.is_published ? 'Move to draft' : 'Publish'
											}
