				...
				<div className='flex items-start justify-between gap-3 border-b border-[var(--color-border)] p-4 sm:p-5'>
					<div>
						...
						<h2
							...
							className='mt-1 flex items-center gap-2 text-xl font-semibold text-[var(--color-text-primary)]'
						>
							...
							{rootComments.length === 0 ? (
								<div className='flex h-52 flex-col items-center justify-center rounded-xl border border-dashed border-[var(--color-border)] bg-[var(--color-input-bg)] py-8 text-center'>
									...
									<p className='text-sm text-[var(--color-text-muted)]'>
										Be the first one to start this discussion.
									</p>
								</div>
							) : (
								<div className='space-y-5'>
									{rootComments.map((comment) => (
										<div
											key={comment.id}
											className='rounded-2xl border border-[var(--color-border)] bg-[var(--color-input-bg)] p-3 shadow-sm sm:p-4'
										>
						...
						<div className='flex-1'>
							...
							<div className='mt-2 flex items-center justify-between gap-3'>
								<p className='text-xs text-[var(--color-text-muted)]'>
									{newComment.trim().length} characters
								</p>
								<button
									type='submit'
