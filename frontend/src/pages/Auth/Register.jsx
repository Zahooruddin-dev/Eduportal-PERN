...
function SkeletonLoader() {
	return (
		<div
			className='auth-page'
			role='status'
			aria-label='Creating your account, please wait'
			aria-live='polite'
		>
				...
				<div className='auth-left' style={leftStyle}>
					...
					<div
						style={{
							...
							borderRadius: '50%',
							background:
								'radial-gradient(circle, rgba(167,141,245,0.08) 0%, transparent 68%)',
							bottom: -80,
							left: -60,
							pointerEvents: 'none',
						}}
							...
							{['Student', 'Teacher'].map((r) => (
								<span
									...
									style={{
										...
										background:
											r === 'Student'
												? 'var(--sb-badge-student-bg)'
												: 'var(--sb-badge-teacher-bg)',
										color:
											r === 'Student'
												? 'var(--sb-badge-student-color)'
												: 'var(--sb-badge-teacher-color)',
				...
				<div className='auth-right' style={rightStyle}>
					...
					>
						...
						<div className='af-2' style={{ marginBottom: 24 }}>
							<FieldLabel htmlFor='reg-username' icon={User}>
								Username
							</FieldLabel>
							<input
								id='reg-username'
								...
								aria-describedby={
									fieldErrors.username ? 'reg-username-error' : undefined
								}
							/>
						...
						<div className='af-3' style={{ marginBottom: 24 }}>
							<FieldLabel htmlFor='reg-email' icon={Mail}>
								Email address
							</FieldLabel>
							<input
								id='reg-email'
								...
								aria-describedby={
									fieldErrors.email ? 'reg-email-error' : 'reg-email-hint'
								}
							/>
							{fieldErrors.email ? (
						...
						<div className='af-4' style={{ marginBottom: 24 }}>
							<FieldLabel htmlFor='reg-password' icon={Lock}>
								Password
							</FieldLabel>
						...
						<div className='af-5' style={{ marginBottom: 8 }}>
							<FieldLabel htmlFor='reg-role' icon={Shield}>
								Account type
							</FieldLabel>
							<div style={{ position: 'relative' }}>
								<select
